...
public class IndexPic {
	 ...
	 * 读取默认配置信息图片的宽度
	 **/
	private double indexPicWidth;
	/***
	 * 读取默认配置信息图片的高度
	 **/
	private double indexPicHeight;
	...
	public double getIndexPicWidth() {
		return indexPicWidth;
	}
	public void setIndexPicWidth(double indexPicWidth) {
		this.indexPicWidth = indexPicWidth;
	}
	public double getIndexPicHeight() {
		return indexPicHeight;
	}
	public void setIndexPicHeight(double indexPicHeight) {
